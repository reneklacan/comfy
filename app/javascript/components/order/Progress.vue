...
const steps = [
  { id: '1', name: 'Detail', href: '#', status: 'complete' },
  { id: '2', name: 'Miesto', href: '#', status: 'current' },
  { id: '3', name: 'Cas', href: '#', status: 'upcoming' },
  { id: '4', name: 'Platba', href: '#', status: 'upcoming' },
  { id: '5', name: 'Suhrn', href: '#', status: 'upcoming' },
]
</script>
